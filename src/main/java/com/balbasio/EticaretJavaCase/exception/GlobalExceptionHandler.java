...
import static com.balbasio.EticaretJavaCase.exception.ErrorType.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EticaretJavaCaseException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleEticaretJavaCaseException(EticaretJavaCaseException exception){
